...
class GymApp(tk.Tk):
    ...
    def create_widgets(self):
        self.logo_image = tk.PhotoImage(file="C:\\Users\\aqk77\\Downloads\\Kau_logo.png")
    ...
    def submit_primary_key(self, event):
        ...
        # Read the Excel file
        df = pd.read_excel("C:\\Users\\aqk77\\Downloads\\GYM_DATA.xlsx", sheet_name="DATA")
        ...
        if int(primary_key) in df["Primary Key"].values:
            ...
            output_file = "C:\\Users\\aqk77\\Downloads\\new_attendees.xlsx"
